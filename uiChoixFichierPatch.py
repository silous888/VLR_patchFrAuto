...
class CheckboxWindowFile(QDialog):
    def __init__(self):
        ...
        num_rows = [5, 16, 1, 1]
        num_cols = [4, 9, 5, 5]
        nom_groups = ["ESCAPE", "NARRATION", "SYSTEM", "ARCHIVE"]
        nom_checkboxes = [listeFichier.LISTE_NOM_ESCAPE_ID, listeFichier.LISTE_NOM_NOVEL_ID, listeFichier.LISTE_NOM_SYSTEM_ID, listeFichier.LISTE_NOM_ARCHIVE_ID]
